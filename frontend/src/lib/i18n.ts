...
const translations = {
  ...
  "trader.researchPhase":  { en: "8 researchers debating...",                                             zh: "8 位研究员辩论中..." },
  ...
  "trader.emptyDesc":      { en: "8 specialist researchers will debate, and a Portfolio Manager will deliver a single decisive call.", zh: "8 位专业研究员将进行辩论，最后由投资经理给出果断的最终决策。" },
