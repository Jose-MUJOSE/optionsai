...
const translations = {
  ...
  // Ticker Search
  "search.placeholder": { en: "Enter US ticker (AAPL, TSLA, ...)", zh: "输入美股代码（如 AAPL、TSLA）" },

  // Market labels (US only — A-shares/HK/forex/futures have no individual stock options)
  "market.us":      { en: "Tech",        zh: "科技" },
  "market.etf":     { en: "ETFs",        zh: "ETF" },
  "market.blue":    { en: "Blue Chips",  zh: "蓝筹" },
  ...
  "search.more": { en: "Show more", zh: "更多" },
  "search.less": { en: "Collapse",  zh: "收起" },
  "search.usOnly": { en: "US market only", zh: "仅支持美股市场" },

  // Sidebar nav
  "nav.dashboard":  { en: "Dashboard",  zh: "仪表盘" },
  "nav.trader":     { en: "Trader Agent", zh: "交易员" },
  ...
  "home.backToHome":    { en: "Back to home",                                                          zh: "返回首页" },

  // Professional Trader Agent
  "trader.title":          { en: "Trader Agent",                                                          zh: "专业交易员" },
  "trader.subtitle":       { en: "Multi-perspective debate · Final PM decision",                          zh: "多视角辩论 · PM 最终决策" },
  "trader.modeStock":      { en: "Analyze Stock",                                                         zh: "分析股票" },
  "trader.modeOptions":    { en: "Analyze Options",                                                       zh: "分析期权" },
  "trader.modeStockHint":  { en: "Get a stock-trading recommendation",                                    zh: "获得股票交易建议" },
  "trader.modeOptionsHint":{ en: "Get an options-strategy recommendation",                                zh: "获得期权策略建议" },
  "trader.runAnalysis":    { en: "Run Analysis",                                                          zh: "开始分析" },
  "trader.running":        { en: "Analyzing...",                                                          zh: "分析中..." },
  "trader.gathering":      { en: "Gathering market data...",                                              zh: "收集市场数据..." },
  "trader.researchPhase":  { en: "10 analysts debating...",                                              zh: "10 位分析师辩论中..." },
  "trader.managerPhase":   { en: "Portfolio Manager deciding...",                                         zh: "投资经理最终决策中..." },
  "trader.complete":       { en: "Analysis complete",                                                     zh: "分析完成" },
  "trader.researchers":    { en: "Researchers",                                                           zh: "研究员" },
  "trader.finalDecision":  { en: "Final Decision",                                                        zh: "最终决策" },
  "trader.thesis":         { en: "Investment Thesis",                                                     zh: "投资逻辑" },
  "trader.entryZone":      { en: "Entry Zone",                                                            zh: "入场区间" },
  "trader.targetPrice":    { en: "Target Price",                                                          zh: "目标价" },
  "trader.stopLoss":       { en: "Stop Loss",                                                             zh: "止损价" },
  "trader.timeHorizon":    { en: "Time Horizon",                                                          zh: "时间周期" },
  "trader.positionSize":   { en: "Position Sizing",                                                       zh: "仓位建议" },
  "trader.structure":      { en: "Structure",                                                             zh: "策略结构" },
  "trader.expiration":     { en: "Expiration",                                                            zh: "到期日" },
  "trader.maxLoss":        { en: "Max Loss",                                                              zh: "最大亏损" },
  "trader.maxProfit":      { en: "Max Profit",                                                            zh: "最大盈利" },
  "trader.breakeven":      { en: "Breakeven",                                                             zh: "盈亏平衡" },
  "trader.winProb":        { en: "Win Probability",                                                       zh: "胜率" },
  "trader.conviction":     { en: "Conviction",                                                            zh: "信心度" },
  "trader.direction":      { en: "Direction",                                                             zh: "方向" },
  "trader.catalysts":      { en: "Key Catalysts",                                                         zh: "关键催化剂" },
  "trader.risks":          { en: "Main Risks",                                                            zh: "主要风险" },
  "trader.debateSummary":  { en: "Debate Summary",                                                        zh: "辩论总结" },
  "trader.evidence":       { en: "Evidence",                                                              zh: "依据" },
  "trader.keyPoints":      { en: "Key Points",                                                            zh: "关键要点" },
  "trader.viewBriefing":   { en: "View briefing",                                                         zh: "查看简报" },
  "trader.downloadReport": { en: "Download Word report",                                                  zh: "下载 Word 报告" },
  "trader.downloading":    { en: "Generating report...",                                                  zh: "生成报告中..." },
  "trader.emptyTitle":     { en: "Pick a ticker, then choose Stock or Options",                           zh: "选择股票代码后，选择「股票」或「期权」" },
  "trader.emptyDesc":      { en: "10 domain-locked specialist analysts will debate 1v1, and a Portfolio Manager will deliver a single decisive call.", zh: "10 位领域独占的专业分析师将进行 1v1 辩论，最后由投资经理给出果断的最终决策。" },
  "trader.stanceBullish":  { en: "Bullish",                                                               zh: "看多" },
  "trader.stanceBearish":  { en: "Bearish",                                                               zh: "看空" },
  "trader.stanceNeutral":  { en: "Neutral",                                                               zh: "中性" },
